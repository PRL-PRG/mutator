...
# The derived-timeout floor is unit-tested directly against determine_mutant_timeout()
# in test-package-orchestration-internals.R, rather than by mocking future_map here.
