...
how mutant timeouts are calibrated, which tests are selected, how parallel
workers are isolated, how to exclude code from mutation, and how the optional
coverage-guided, precise-location, and equivalent-mutant-detection features
behave. See `?mutate_package` for the full argument and return-value
documentation.
